<?php
	...
	{
		$result = get_rows("select user_id, first_name, last_name, email, user_name, password, address1, address2, city, zipcode, country, state, zipcode, profile_pic from  users where user_id = ?", array($_SESSION['user']));
...
?>
		...
		<div class="login_icon">
			<ul class="login-status">
				...
				<?php  echo "Welcome ".$array_user_data['user_name']; ?></a></li>
		...
		<div class="container-fluid content">
			...
			<div class="col-sm-5">
				<div class="profile-box">
					<h3> My profile</h3>
					<form name="profile" role="form" method="post" action="controller/edit_profile_byuser.php"  onsubmit="return validform()">
				    	...
				    	<button type="submit" class="btn btn-default" onclick="validform()">submit</button>
				    </form>
				</div>    
			</div>	
		</div>	
