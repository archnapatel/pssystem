<?php
	...
	if(isset($_SESSION['admin']))
	{
		...
		/*if(isset($_SESSION['set_image']))
		{
			$id = $_SESSION['set_image'];
		}*/	
		$result = get_row("select user_id, first_name, last_name, email, user_name, password, address1, address2, city, zipcode, country, state, zipcode, profile_pic from  registration where user_id = ?",array($_SESSION['user_id']));
...
<div class="container-fluid content">
	<div class="col-md-3">
		<form method="post" action="controller/upload_img_byadmin.php" enctype="multipart/form-data">
			<div class="img-box">
